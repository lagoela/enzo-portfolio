        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="text-center mb-8 sm:mb-12">
            ...
            <p className="text-base sm:text-lg text-gray-600 max-w-2xl mx-auto px-4">
              Here are some of the projects I've been working on, focusing on
              backend systems and API development.
            </p>
            <p className="text-base sm:text-md text-gray-600 max-w-2xl mx-auto px-4">
      ...
      <section className="py-12 sm:py-16 lg:py-20">
        <div className="container mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="text-base sm:text-lg text-gray-600 mb-6 sm:mb-8 max-w-2xl mx-auto px-4">
            Feel free to contact me for any collaboration, freelance
            opportunities, or just to connect and chat about backend
            development!
          </p>
          <Button
